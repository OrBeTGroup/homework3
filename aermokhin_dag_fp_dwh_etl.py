...
SQL_CONTEXT = {
    ...
    'SATELLITES': {
           ...
           'DROP_VIEW_ONE_YEAR': """
                drop view if exists 
                aermokhin.fp_view_payment_{{ execution_date.year }},
                aermokhin.fp_view_billing_{{ execution_date.year }},
                aermokhin.fp_view_issue_{{ execution_date.year }},
                aermokhin.fp_view_traffic_{{ execution_date.year }}
                """
}
